...
const FloatingWhatsApp = () => {
  ...
  const whatsappNumber = "6282284890492"
  const message = "Halo, saya tertarik dengan Sora Studio Asset Pack!"
      ...
      {isVisible && (
        ...
        >
          ...
          <a
            ...
            className="group flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-[#25D366] rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300"
          >
            {/* Pulse ring */}
